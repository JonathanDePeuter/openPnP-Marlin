 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { (5 * 32), (5 * 32), (5 * 32) , 1 , 8.8888 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 800, 500 ,500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -2, 0, 0 }
...
// Homing speeds (linear=mm/min, rotational=°/min) 30 * 60
#define HOMING_FEEDRATE_MM_M { (5000), (5000), (5000), (20*60), (20*60) }

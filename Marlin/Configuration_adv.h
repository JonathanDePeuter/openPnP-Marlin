...
#define HOMING_BUMP_MM      { 5, 5, 5, 1, 1}       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 20*60, 20*60, 20*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
